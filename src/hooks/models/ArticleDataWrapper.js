...
export default class ArticleDataWrapper {
    ...
    _parseSettings(rawData) {
        ...
        return {
            ...
            // - ArticleContactForm
            emailJsPublicKey: rawSettings["email_js_public_key"] || import.meta.env.VITE_EMAILJS_PUBLIC_KEY,
            emailJsServiceId: rawSettings["email_js_service_id"] || import.meta.env.VITE_EMAILJS_SERVICE_ID,
            emailJsTemplateId: rawSettings["email_js_template_id"] || import.meta.env.VITE_EMAILJS_TEMPLATE_ID,
        }
    }
